...
RSpec.describe CustomersController, type: :controller do
  ...
  let(:valid_attributes) {
    {
        email_address: 'nilayanand123@gmail.com',
        first_name:'Nilay ',
        last_name:'Anand',
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved customer as @customer" do
        post :create, customer: invalid_attributes, session: valid_session
        expect(assigns(:customer)).to be_a_new(Customer)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested customer" do
        customer = Customer.create! valid_attributes
        put :update, id: customer.to_param, customer: new_attributes, session: valid_session
        customer.reload
        expect(customer.email_address).to match( new_attributes[:email_address] )
      end

      it "assigns the requested customer as @customer" do
        customer = Customer.create! valid_attributes
        put :update, id: customer.to_param, customer: valid_attributes, session: valid_session
        expect(assigns(:customer)).to eq(customer)
      end
    ...
    context "with invalid params" do
      it "assigns the customer as @customer" do
        customer = Customer.create! valid_attributes
        put :update, id: customer.to_param, customer: invalid_attributes, session: valid_session
        expect(assigns(:customer)).to eq(customer)
      end
