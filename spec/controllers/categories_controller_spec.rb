...
RSpec.describe CategoriesController, type: :controller do
  ...
  let(:valid_attributes) {
    {name: 'for test category', description: 'test descrption'}
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {name: 'updated test category', description: 'test descrption'}
      }
      ...
      it "updates the requested category" do
        ...
        category.reload
        expect(category.name).to match( new_attributes[:name] )
      end
